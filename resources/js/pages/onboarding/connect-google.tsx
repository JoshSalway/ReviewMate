            ...
            return (
                <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        <p className="text-xs text-gray-400">Auto-filled from your Google Business Profile. You can edit this if needed.</p>
                    </div>
                </div>
            );
        }
            ...
            <>
                ...
                <div className="mb-4 space-y-2">
                    ...
                    <Input
                        ...
                        className="font-mono text-sm"
                    />
                    <p className="text-xs text-gray-400">Your Place ID uniquely identifies your business on Google Maps.</p>
                </div>
            ...
            <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
                <div className="w-full max-w-lg">
                    ...
                    <div className="mb-8 text-center">
                        ...
                        <p className="mt-2 text-gray-500">We need your Google Place ID to send customers directly to your review page.</p>
                    </div>
