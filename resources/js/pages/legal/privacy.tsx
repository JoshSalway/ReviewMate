                ...
                <main className="mx-auto max-w-3xl px-6 pb-24 pt-10">
                    ...
                    <div className="prose prose-gray max-w-none space-y-10 text-[15px] leading-relaxed text-foreground">
                        ...
                        <section>
                            ...
                            <h3 className="mb-2 mt-5 font-semibold text-foreground">Account information</h3>
                            <p>
                            ...
                            <h3 className="mb-2 mt-5 font-semibold text-foreground">Business information</h3>
                            <p>
                            ...
                            <h3 className="mb-2 mt-5 font-semibold text-foreground">Customer data you upload</h3>
                            <p>
                            ...
                            <h3 className="mb-2 mt-5 font-semibold text-foreground">Review data</h3>
                            <p>
                            ...
                            <h3 className="mb-2 mt-5 font-semibold text-foreground">Usage data</h3>
                            <p>
                            ...
                            <h3 className="mb-2 mt-5 font-semibold text-foreground">Payment data</h3>
                            <p>
                        ...
                        <section>
                            <h2 className="mb-3 text-xl font-bold text-foreground">3. Third-Party Service Providers</h2>
                            <p className="mb-4">
                                ...
                                <table className="w-full text-sm">
                                    <thead>
                                        <tr className="bg-muted text-left">
                                            ...
                                            <th className="px-4 py-3 font-semibold text-foreground">Data shared</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-border">
                                        <tr>
                                            ...
                                            <td className="px-4 py-3 text-muted-foreground">Name, email</td>
                                        </tr>
                                        <tr className="bg-muted/50">
                                            <td className="px-4 py-3 font-medium">Google</td>
                                            <td className="px-4 py-3 text-muted-foreground">Business Profile API, OAuth</td>
                                            <td className="px-4 py-3 text-muted-foreground">Google account tokens, location data, reviews</td>
                                        </tr>
                                        <tr>
                                            <td className="px-4 py-3 font-medium">Stripe</td>
                                            <td className="px-4 py-3 text-muted-foreground">Payments & billing</td>
                                            <td className="px-4 py-3 text-muted-foreground">Name, email, billing details</td>
                                        </tr>
                                        <tr className="bg-muted/50">
                                            <td className="px-4 py-3 font-medium">Twilio</td>
                                            <td className="px-4 py-3 text-muted-foreground">SMS delivery</td>
                                            <td className="px-4 py-3 text-muted-foreground">Customer phone numbers, message content</td>
                                        </tr>
                                        <tr>
                                            <td className="px-4 py-3 font-medium">Anthropic</td>
                                            <td className="px-4 py-3 text-muted-foreground">AI reply suggestions</td>
                                            <td className="px-4 py-3 text-muted-foreground">Review text, business name and type</td>
                                        </tr>
                                        <tr className="bg-muted/50">
                                            <td className="px-4 py-3 font-medium">Mailgun / Resend</td>
                                            <td className="px-4 py-3 text-muted-foreground">Transactional email</td>
                                            <td className="px-4 py-3 text-muted-foreground">Customer names, emails, message content</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <section>
                            <h2 className="mb-3 text-xl font-bold text-foreground">7. Your Rights</h2>
                            <p className="mb-3">
                        ...
                        <section>
                            <h2 className="mb-3 text-xl font-bold text-foreground">8. Email and SMS Communications</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="mb-3 text-xl font-bold text-foreground">9. Children's Privacy</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="mb-3 text-xl font-bold text-foreground">10. Changes to This Policy</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="mb-3 text-xl font-bold text-foreground">11. Contact Us</h2>
                            <p>
                                For privacy-related enquiries, complaints, or to exercise your rights, please contact our privacy team at:
                            </p>
                            <div className="mt-3 rounded-xl border border-border bg-muted p-5 text-sm">
                                <p className="font-semibold text-foreground">ReviewMate</p>
                ...
                <footer className="border-t border-border py-8">
                    <div className="mx-auto max-w-6xl px-6 flex flex-col items-center gap-3 sm:flex-row sm:justify-between">
                        ...
                        <div className="flex items-center gap-4 text-xs text-muted-foreground">
                            ...
                            <Link href="/privacy" className="hover:text-muted-foreground transition-colors font-medium text-muted-foreground">Privacy</Link>
