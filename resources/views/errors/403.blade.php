...
<head>
    ...
    <title>Access Denied — ReviewMate</title>
...
<body class="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4">
    <div class="w-full max-w-md text-center">
        ...
        <div class="rounded-xl bg-white p-8 shadow-sm ring-1 ring-gray-100">
            <div class="mb-4 text-6xl font-bold text-teal-600">403</div>
            <h1 class="mb-2 text-xl font-semibold text-gray-900">Access denied</h1>
